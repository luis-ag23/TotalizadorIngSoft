...
function calcularTotalizador(
  ...
  // DESCUENTO FIJO QUE FALTABA
  let descuento_cliente_categoria = 0;

  if (Cliente === "Recurrente" && categoria === "Alimentos" && precioNeto > 3000) {
    descuento_cliente_categoria = 100;
  }

  if (Cliente === "Especial" && categoria === "Electronicos" && precioNeto > 7000) {
    descuento_cliente_categoria = 200;
  }

  const precio_descuento_total = precio_descuento_xcantidad - descuento_categoria - descuento_cliente_categoria;
  ...
  return {
    ...
    descuento_cliente_categoria: descuento_cliente_categoria,
    impuesto_categoria: impuesto_categoria,
    impuesto_estado: impuesto_estado,
