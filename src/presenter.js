...
const descuentoClienteCategoria = document.querySelector("#descuento-cli-cat");
const impuestoEstado = document.querySelector("#impuesto-estado");
const descuentoEnvio = document.querySelector("#descuento-envio");
const costoEnvioFinal = document.querySelector("#costo-envio-final");
...
calcularButton.addEventListener("click", () => {
  ...
  descuentoClienteCategoria.textContent = String(resultado.descuento_cliente_categoria);
  impuestoEstado.textContent = String(resultado.impuesto_estado);
  descuentoEnvio.textContent = String(resultado.descuento_envio);
  costoEnvioFinal.textContent = String(resultado.costo_envio_final);
});